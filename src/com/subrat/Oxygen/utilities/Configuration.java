...
public class Configuration {
    ...
    private final static float MIN_VELOCITY = 0.03F; // In dp per msec

    private final static int   REFRESH_INTERVAL = 10; // In msec
    private final static float COLLISION_THRESHOLD = 1F; // In dp
    ...
    private final static float CIRCLE_DEVIATION_THRESHOLD = 40F;
    private final static int   LINE_MIN_PIXELS = 10;
    private final static int   CIRCLE_MIN_PIXELS = 10;
    private final static float LINE_MIN_LENGTH = 20F; // In dp
    private final static float CIRCLE_MIN_RADIUS = 20F; // In dp

    private final static float GRAVITY_SCALE = 0.0001F; // Convert mtr per sec per sec to dp per msec per msec
    ...
    public static float getLineMinLength() { return MathUtils.getPixelFromDP(LINE_MIN_LENGTH); }
    public static float getCircleMinRadius() { return MathUtils.getPixelFromDP(CIRCLE_MIN_RADIUS); }
}
